...
```
python auto_gpt/main.py --continuous
...
```
python auto_gpt/main.py --gpt3only
```
...
```
flake8 auto_gpt/ tests/

# Or, if you want to run flake8 with the same configuration as the CI:
flake8 auto_gpt/ tests/ --select E303,W293,W291,W292,E305,E231,E302
```
