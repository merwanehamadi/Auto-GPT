...
MAX_LEVEL_TO_IMPROVE_ON = 1  # we will attempt to beat 1 level above the current level for now.
    ...
    def wrapper(*args: Any, **kwargs: Any) -> None:
        ...
        while run_remaining > 0:
            ...
            if os.environ.get("CI") == "true":
                new_max_level_beaten = get_new_max_level_beaten(challenge, Challenge.BEAT_CHALLENGES)
                update_new_score(
...
def get_new_max_level_beaten(challenge, beat_challenges):
