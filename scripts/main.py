...
class AutonomousAgent():
    def __init__(self,
        ...
        self.cfg = cfg
        self.prompt = prompt
        self.full_message_history = full_message_history if full_message_history else []
        self.result = result
    ...
    def start_loop(self):
        ...
        try:
            while True:
                ...
                with Spinner("Thinking... "):
                    assistant_reply = chat.chat_with_ai(
                        ...
                        self.memory,
                        self.cfg.fast_token_limit) # TODO: This hardcodes the model to use GPT3.5. Make this an argument
            ...
            # when the agent shutdowns naturally after task completion, it raises a SystemExit exception
            pass
