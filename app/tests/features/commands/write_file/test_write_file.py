...
import pytest
from app.tests.features.test_helpers import compare_old_response_to_new_response, build_response, get_response_async, \
...
async def test_write_file(config, client: AsyncClient) -> None:
    ...
    ## should be 500 because the autonomous agent should
